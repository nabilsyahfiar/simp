...
namespace App\Filament\Staff\Resources\HouseUnits;

use App\Filament\Resources\HouseUnits\Schemas\HouseUnitForm;
use App\Filament\Resources\HouseUnits\Tables\HouseUnitsTable;
use App\Filament\Staff\Resources\HouseUnits\Pages\CreateHouseUnit;
use App\Filament\Staff\Resources\HouseUnits\Pages\EditHouseUnit;
use App\Filament\Staff\Resources\HouseUnits\Pages\ListHouseUnits;
...
class HouseUnitResource extends Resource
{
    ...
    {
        return RoleMenuAccess::canAccess('staff', 'house_units')
            && RolePermissionAccess::canAccess('staff', 'house_units', 'view');
    }
    ...
    {
        return RolePermissionAccess::canAccess('staff', 'house_units', 'create');
    }

    public static function canEdit(Model $record): bool
    {
        return RolePermissionAccess::canAccess('staff', 'house_units', 'edit');
    }

    public static function canDelete(Model $record): bool
    {
        return RolePermissionAccess::canAccess('staff', 'house_units', 'delete');
    }
